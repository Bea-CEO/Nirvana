...
public class NirvanaTags {
    ...
    public static final TagKey<Block>[] HEMP_SEASONS_BLOCKS = new TagKey[] {
            TagKey.create(Registries.BLOCK, new ResourceLocation("sereneseasons", "spring_crops")),
            TagKey.create(Registries.BLOCK, new ResourceLocation("sereneseasons", "summer_crops"))
    };

    public static final TagKey<Item>[] HEMP_SEASONS_ITEMS = new TagKey[] {
            TagKey.create(Registries.ITEM, new ResourceLocation("sereneseasons", "spring_crops")),
            TagKey.create(Registries.ITEM, new ResourceLocation("sereneseasons", "summer_crops"))
    };
